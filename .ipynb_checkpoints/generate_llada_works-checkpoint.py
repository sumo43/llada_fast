...
if __name__ == '__main__':
    ...
    parser.add_argument('--steps', type=int, default=128, help='Sampling steps for LLaDA diffusion')
    parser.add_argument('--block_length', type=int, default=32, help='Block length for LLaDA diffusion')
